...
class QuizInterface:
    ...
    def display_title(self):
        ...
        # Title
        title = Label(self.window, text="The Quiz Application",
                      width=50, bg="#50623A", fg="white", font=("Poppins", 20, "bold"))
    ...
    def buttons(self):
        ...
        next_button = Button(self.window, text="Next", command=self.next_btn,
                             width=10, bg="#50623A", fg="white", font=("Poppins", 16, "bold"))
        ...
        quit_button = Button(self.window, text="Quit", command=self.window.destroy,
                             width=5, bg="red", fg="white", font=("Poppins", 16, " bold"))
